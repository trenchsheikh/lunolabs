...
export const SponsorsSection = () => {
  return (
    <section id="sponsors" className="max-w-full mx-auto pb-16 sm:pb-24 overflow-hidden">
      <h3 className="text-lg md:text-xl font-semibold text-center mb-8">
        Built with <span className="text-primary">Trusted Technologies</span>
      </h3>
      
      <Marquee className="py-4">
        <MarqueeFade side="left" />
        <MarqueeFade side="right" />
        <MarqueeContent className="gap-8">
